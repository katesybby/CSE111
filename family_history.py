...
def print_death_age(people_dict):
    ...
    for person_key, person_list in people_dict.items():
        ...
        print("Ages at Death")
        print (f"{name} {death_age}, {birth} - {death}")
...
def print_marriages(marriages_dict, people_dict):
    ...
    for marriage_key, marriage_list in marriages_dict.items():
        ...
        wedding_yr = marriage_list[WEDDING_YEAR_INDEX]
        ...
        husband_age = wedding_yr - husband_birth
        ...
        wife_age = wedding_yr - wife_birth


        print ("Marriages")
        print (f"{husband_name} {husband_age} > {wedding_yr} < {wife_name} {wife_age}")
